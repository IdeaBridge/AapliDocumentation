...
{% include image.html file="edit_a_user.jpg" url="https://admin.aapli.co/admin/operations/users" alt="Edit a User" caption="Edit a User" %}
...
{% include image.html file="toggle_user_account.jpg" url="https://admin.aapli.co/admin/operations/users" alt="Toggle a User" caption="Toggle a User" %}
...
{% include image.html file="delete_user1.jpg" url="https://admin.aapli.co/admin/operations/users" alt="Delete a User" caption="Delete a User" %}
...
{% include image.html file="delete_user2.jpg" url="https://admin.aapli.co/admin/operations/users" alt="Delete a User" caption="Delete a User" %}
